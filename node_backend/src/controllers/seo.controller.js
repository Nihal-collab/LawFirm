...
const getSeoMetadataByPath = asyncHandler(async (req, res) => {
  ...
  if (!seo) {
    ...
    const fallbacks = {
      '/': {
        title: 'ROOTS-IP Partners | Elite IP Rights Legal Counsel',
        meta_description: 'ROOTS-IP Partners is a premier international intellectual property law firm specializing in patent prosecution, trademark portfolio management, copyrights, and litigation.',
      ...
      '/about': {
        title: 'About Us | ROOTS-IP Partners',
        meta_description: "Learn about ROOTS-IP Partners' history, mission, and our expert team of patent agents, PhD technical specialists, and IPR attorneys.",
        keywords: 'about law firm, ip experts, patent agents india, Nariman Point lawyers',
        og_image: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=1200&auto=format&fit=crop',
      },
      '/services': {
        title: 'Our Practice Areas | ROOTS-IP Partners',
      ...
      '/team': {
        title: 'IP Attorneys & patent agents | ROOTS-IP Partners',
      ...
      '/blog': {
        title: 'Intellectual Property Insights & Blog | ROOTS-IP Partners',
      ...
      '/faqs': {
        title: 'IPR Frequently Asked Questions | ROOTS-IP Partners',
      ...
      '/contact': {
        title: 'Contact nariman point office | ROOTS-IP Partners',
      ...
      '/book-consultation': {
        title: 'Book a Confidential Consultation | ROOTS-IP Partners',
      ...
      '/gallery': {
        title: 'Firm Gallery & Events | ROOTS-IP Partners',
      ...
      '/client-success': {
        title: 'Client Success Case Studies | ROOTS-IP Partners',
    ...
    const matched = fallbacks[pathVal] || {
      title: 'ROOTS-IP Partners | Elite IP Rights Legal Counsel',
      meta_description: 'Secure your intellectual property portfolios worldwide with registered patent agents and litigators at ROOTS-IP Partners.',
