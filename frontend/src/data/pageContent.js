...
export const homeContent = {
  ...
  hero_subtitle: "ROOTSIP Partners provides elite, cross-border patent prosecution, strategic trademark portfolio management, and rigorous copyright enforcement for pioneering technology companies.",
  ...
  stats_countries: "45+",
  why_choose_title: "Why Global Innovators Choose ROOTSIP",
...
export const aboutContent = {
  ...
  history_timeline: [
    { year: "2015", event: "ROOTSIP Partners founded by veteran IP litigators in response to cross-border tech infringement rises." },
